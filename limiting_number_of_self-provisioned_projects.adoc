...
The above configuration sets a global limit of 5 projects per user while
...
image:images/3-projects.png[image]

Try to create more than 5 projects (name them anything you wish)…you
will see an error when you try to create more than 5 projects.

image:images/no-more-projects.png[image]
...
user gets the default ``5'' max projects. You can take a look at the
